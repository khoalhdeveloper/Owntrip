...
exports.findProvinceImageByDestination = exports.getProvinceImages = exports.normalizeText = void 0;
...
const toSlug = (value) => (0, exports.normalizeText)(value).replace(/\s+/g, "-");
const PROVINCE_IMAGES = PROVINCE_NAMES.map((provinceName) => {
    const slug = toSlug(provinceName);
    const baseKeywords = [(0, exports.normalizeText)(provinceName)];
    const aliasKeywords = (PROVINCE_ALIASES[provinceName] || []).map(exports.normalizeText);
...
const getProvinceImages = () => PROVINCE_IMAGES;
exports.getProvinceImages = getProvinceImages;
const findProvinceImageByDestination = (destination) => {
    const input = (0, exports.normalizeText)(destination || "");
    if (!input) {
        return null;
    }
    let bestMatch = null;
...
exports.findProvinceImageByDestination = findProvinceImageByDestination;
